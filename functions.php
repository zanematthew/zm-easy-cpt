...
Class zMHelpers {
     ...
     * @todo use more core
     */
    private function zm_base_build_options( $taxonomy=null, $value=null ) {
...
Class zMSubmission{
     ...
     */
    private function zm_easy_cpt_verify_post_submission( $post_type=null, $ajax_action=null ){
     ...
     * @package Ajax
     */
    private function zm_easy_cpt_security_fields( $action=null, $post_type=null ){
     ...
     * @package Ajax
     */
    private function zm_easy_cpt_form_status(){
